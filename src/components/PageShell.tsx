  ...
  return (
    <div className="min-h-dvh bg-paper text-ink">
      <header className="fixed top-0 left-0 right-0 z-30 border-b border-ink/[0.04]" style={{ background: "rgba(245,245,240,0.8)", backdropFilter: "blur(20px) saturate(1.2)" }}>
        <div className="flex items-center justify-between h-14 sm:h-16 px-4 sm:px-8 lg:px-16 max-w-[1440px] mx-auto">
          ...
          <div className="text-right">
            ...
            {subtitle && <p className="text-[0.56rem] sm:text-[0.58rem] text-ink/32 tracking-[0.04em] mt-0.5 hidden sm:block">{subtitle}</p>}
          </div>
        </div>
      </header>
